...
|-------|-------------|-----------|
| `rpgMenu/open` | rpgMenu/open operation | Listen / Emit |
| `rpgMenu/close` | rpgMenu/close operation | Listen / Emit |
| `rpgMenu/navigate` | rpgMenu/navigate operation | Listen / Emit |
| `rpgMenu/select` | rpgMenu/select operation | Listen / Emit |
