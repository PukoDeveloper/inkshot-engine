...
|-------|-------------|-----------|
| `parallax/add` | parallax/add operation | Listen / Emit |
| `parallax/remove` | parallax/remove operation | Listen / Emit |
| `parallax/update` | parallax/update operation | Listen / Emit |
| `parallax/scroll` | parallax/scroll operation | Listen / Emit |
