...
const { core } = await createEngine({
  plugins: [/* GradientLightingPlugin */],
});
```
...
|-------|-------------|-----------|
| `gradient-lighting/add` | gradient-lighting/add operation | Listen / Emit |
| `gradient-lighting/remove` | gradient-lighting/remove operation | Listen / Emit |
| `gradient-lighting/update` | gradient-lighting/update operation | Listen / Emit |
